  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="{{route('manageusers.index')}}"><i class="fa fa-file"></i> <span>Users</span></a></li>
        ...
        <li><a href="/test-admin"><i class="fa fa-file"></i> <span>Tables</span></a></li>

        <!-- Optionally, you can add icons to the links -->
        <li><a href="{{route('testAdmin.contact')}}"> <i class="fa fa-envelope"></i>  <span>Contacts</span></a></li>

        <!-- Optionally, you can add icons to the links -->
        <li><a href="{{route('testAdmin.order')}}"><i class="fa fa-folder"></i> <span>Orders</span></a></li>
        <!-- Optionally, you can add icons to the links -->
        <li><a href="#"><i class="fa fa-file"></i> <span>Settings</span></a></li>
...
<!-- AdminLTE dshboard demo (This is only for demo purposes) --
