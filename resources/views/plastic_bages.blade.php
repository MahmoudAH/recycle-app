...
-->
    ...
    <div class="video">
     <iframe style="margin-top: 40px" width="400" height="315" src="https://www.youtube.com/embed/Q6hzhKmw4EY"
             frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe> 
         <h3 style="color: #FF8C00;padding: 5px">PLASTIC BAGES RECYCLING </h3>
    </div>
    
    
    <div id="explore2"> <a href="\"> <button>
